...
This devcontainer configuration provides a consistent development environment for the megarepo.

## Setup

This devcontainer installs Python 3.12 via the official devcontainer Python feature.
