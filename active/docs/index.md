...
This directory contains actively maintained projects and experiments. Projects here are organized by category.
...
Each project contains its own `README.md` with specific instructions for setup and development. Start with the project-specific README for details on:
...
See [PHILOSOPHY.md](../../PHILOSOPHY.md) for the development principles used across this repository.
