...
A dashboard that can start, stop, and link to every web-based app in the megarepo.
...
- **Discovers** all web apps registered in [`apps.yaml`](apps.yaml)
...
Edit [`apps.yaml`](apps.yaml) to add or modify apps. Each entry specifies:
