...
""".strip()
    ...
    def test_helper_methods(self):
        ...
        offenders = self.lizard._lizard_offenders([{"ccn": 9.0}, {"ccn": 12.0}])
        self.assertEqual(len(offenders), 2)
        summary = self.lizard._lizard_summary([], [9.0, 12.0], offenders)
        self.assertEqual(summary["threshold"], self.lizard.max_ccn)
