...
from .config import RuntimeConfig, TCIConfig
...
from .models import AgentVariant, ExecutionMode, to_jsonable
from .replay import compare_variants, rerun_trace, save_bundle, save_run_result
...
def build_parser() -> argparse.ArgumentParser:
    parser = argparse.ArgumentParser(description="TCI framework testbed for Manifold prediction markets")
